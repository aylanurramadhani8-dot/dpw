...
function queryCount($koneksi, $sql)
{
...
$totalDosen = queryCount($koneksi, "SELECT COUNT(*) as total FROM t_dosen");
$totalMhs = queryCount($koneksi, "SELECT COUNT(*) as total FROM t_mahasiswa");
$totalMK = queryCount($koneksi, "SELECT COUNT(*) as total FROM t_matakuliah");

// Ambil 5 dosen terakhir
$recentDosen = mysqli_query($koneksi, "SELECT idDosen, namaDosen FROM t_dosen ORDER BY idDosen DESC LIMIT 5");
// Ambil 5 mahasiswa terakhir
    ...
    <div class="recent-grid fade-in">
        <div class="recent-card">
            ...
            <table class="data-table compact">
                ...
                <tbody>
                    <?php
                    if ($recentDosen && mysqli_num_rows($recentDosen) > 0) {
        ...
        <div class="recent-card">
            ...
            <table class="data-table compact">
                ...
                <tbody>
                    <?php
                    if ($recentMhs && mysqli_num_rows($recentMhs) > 0) {
