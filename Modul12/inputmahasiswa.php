    ...
    <div class="card form-card fade-in">
        ...
        <form action="proses_inputmahasiswa.php" method="POST">
            <div class="form-group">
                ...
                <input type="number" name="npm" id="npm" placeholder="Contoh: 253307001" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="alamat" id="alamat" placeholder="Contoh: Jl. Sudirman No. 10, Jakarta"
                    required>
            </div>
            <div class="form-group">
